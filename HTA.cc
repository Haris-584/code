...
//const long int stime;
  ...
  cmd.AddValue ("packetSize1", "size of application packet sent", packetSize1);
...
//Animation
AnimationInterface anim("HTA.xml");

//Ascii format tracing
AsciiTraceHelper ascii;
wifiPhy.EnableAsciiAll(ascii.CreateFileStream("HTA.tr"));    
